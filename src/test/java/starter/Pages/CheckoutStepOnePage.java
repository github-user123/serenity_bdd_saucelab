...
public class CheckoutStepOnePage extends PageObject {
    ...
    private String pageURL ="https://www.saucedemo.com/v1/checkout-step-one.html";
    private final By firstnameField = By.id("first-name");
    private final By lastnameField = By.id("last-name");
    private final By postalCodeField = By.id("postal-code");
    private final By itemName = By.className("inventory_item_name");
    private final By continueButton = By.xpath("//*[@id=\"checkout_info_container\"]/div/form/div[2]/input");
